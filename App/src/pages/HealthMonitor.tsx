...
import { Home, Heart, Activity, Thermometer, LineChart, Plus, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 pb-8">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="mt-1 text-gray-500">追蹤寵物的健康狀況</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">
              {records[records.length - 1]?.temperature || '--'} °C
            </p>
            <p className="text-sm text-gray-500 mt-2">
              最後更新：{records[records.length - 1]?.recorded_at ? 
                new Date(records[records.length - 1].recorded_at).toLocaleString('zh-TW') : '--'}
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">
              {records[records.length - 1]?.heart_rate || '--'} BPM
            </p>
            <p className="text-sm text-gray-500 mt-2">
              最後更新：{records[records.length - 1]?.recorded_at ? 
                new Date(records[records.length - 1].recorded_at).toLocaleString('zh-TW') : '--'}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-3xl font-bold text-gray-900">
              {records[records.length - 1]?.oxygen_level || '--'}%
            </p>
            <p className="text-sm text-gray-500 mt-2">
              最後更新：{records[records.length - 1]?.recorded_at ? 
                new Date(records[records.length - 1].recorded_at).toLocaleString('zh-TW') : '--'}
